...
@Component({
  selector: 'app-show-function-schlag',
  templateUrl: './show-function-schlag.component.html',
  styleUrls: ['./show-function-schlag.component.css']
})
export class ShowFunctionSchlagComponent implements OnInit {
